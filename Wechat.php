            ...
            [
                ...
                'sublist' => [
                    ...
                    [
                        ...
                        'icon'    => 'fa fa-cog',
                        'sublist' => [
                            ['name' => 'wechat/doctor/index', 'title' => '查看'],
                            ['name' => 'wechat/doctor/add', 'title' => '添加'],
                            ['name' => 'wechat/doctor/edit', 'title' => '修改'],
                            ['name' => 'wechat/doctor/del', 'title' => '删除'],
                            ['name' => 'wechat/doctor/multi', 'title' => '批量更新'],
                        ]
                    ],
                    // [
                    //     'name'    => 'wechat/config',
