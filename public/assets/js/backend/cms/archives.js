                    ...
                    [
                        ...
                        },
                        {
                            field: 'title', title: __('Title'), align: 'left', formatter: function (value, row, index) {
                                return '<div class="archives-title">' + value + '</div>' +
                                    '<div class="archives-label">' + Table.api.formatter.flag.call(this, (row['recommend'])?'recommend':'', row, index) + '</div>';
                            }
                        },
                        ...
                        {field: 'status', title: __('Status'), searchList: {"normal": __('Status normal'), "hidden": __('Status hidden'), "rejected": __('Status rejected'), "pulloff": __('Status pulloff')}, formatter: Table.api.formatter.status},
                        {
                            ...
                            {
                                name: 'detail',
                                text: __('Cancel') + __('Recommend'),
                                icon: 'fa fa-list',
                                classname: 'btn btn-warning btn-xs btn-detail btn-ajax',
                                url: 'cms/archives/unrecommend',
                                visible: function (row) {
                                    return row['recommend']
                                },
                                success: function (data, ret) {
