...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_archives_recommend` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '会员ID',
  `archive_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '栏目ID',
  PRIMARY KEY (`id`),
  UNIQUE KEY `admin_id` (`archive_id`,`admin_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='内容推荐表';


CREATE TABLE IF NOT EXISTS `__PREFIX__cms_archives_action` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
  `archive_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文章ID',
  `action` varchar(100) DEFAULT NULL COMMENT '动作',
  `createtime` int(10) DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`archive_id`,`user_id`,`action`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='内容操作表';
--
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_page` (
  ...
  `times_share` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '分享次数',
  `times_fav` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '点赞次数',
